...
from src.config import OUT_PATH, FREQ_BAND, event_idx, color_event
from src.setting import ExcludSubj, GetInfo
from src.decomposition import DataTransformationM1
